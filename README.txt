...
USAGE
Download the application and open includes/connection.php - Replace the database settings with your DB settings and go to <your-url>/admin. Create a new user in the register page. NOTE: there is no password reset or password retrieve implemented.
